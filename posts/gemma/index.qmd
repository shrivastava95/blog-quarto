...
date: "2026-06-23T17:42:51+05:30"
date-modified: "2026-06-23T17:42:51+05:30"
format:
  html:
    toc: true
...
1. **Residual stream gating the PLE lookup** - A simple hypothesis I agree with[^2] is that the layer-wise lookup allows the model to store and recall a great deal of information as the lookup is precomputed for every forward pass, instead of going through matmuls in the MLP, thereby increasing capacity without commensurate increases in VRAM occupancy.
...
Do try it out. I'm tryna find good subsets smaller than E2B rn, here's two I found that inferenced just fiiine.
- [capriciousmarauder/test-submodel-3](https://huggingface.co/capriciousmarauder/test-submodel-3) This one is more sliced than E2B.
- [capriciousmarauder/test-submodel-4](https://huggingface.co/capriciousmarauder/test-submodel-4) This one is very aggressively sliced, even more than the other one.
...
[^2]: The credit for this particular hypothesis as well as elicitation of a lot of the discussion in the blog is thanks to aletheia who is the creator of Mirage, a custom zeroth-order optimization library for Episteme, a superhuman UCI chess engine - [check out their blog!](https://aletheiaaaaa.github.io/index.html)
