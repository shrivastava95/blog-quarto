...
Before CPU offload:
![gemma01_before_cpu.png](gemma01_before_cpu.png)

After CPU offload:
![gemma02_after_cpu.png](gemma02_after_cpu.png)
...
Ignoring the weird error bars on the rightmost chart for x=8, we can see that the average performance over validation generally improves with increase in PLE dimension 
